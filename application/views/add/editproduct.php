...
<body>
    ...
    <form action="<?php echo site_url('product/updateproduct') ?>" method="post" enctype="multipart/form-data">
        ...
        <div style="margin-left: 20px">
                ...
                <div class="col-5">
                    ...
                    <select class="form-control" name="prodtype" id="prodtype" required oninvalid="this.setCustomValidity('กรุณาเลือกประเภท')" oninput="setCustomValidity('')">
                        ...
                        <?php foreach ($protype as $pt) { ?>
                            <option value="<?php echo $pt->Prot_Id; ?>"<?php if ($ed->Prod_Type == $pt->Prot_Id){
                                echo "selected";
                            } ?>>
            ...
            <div class="row justify-content-center">
                <div class="col-5">
                    ...
                    <input class="form-control" type=text name="prodname" id="prodname" value="<?php echo $ed->Prod_Name; ?>" required oninvalid="this.setCustomValidity('กรุณากรอกชื่อสินค้า')" oninput="setCustomValidity('')">
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-5">
                    ...
                    <select class="form-control" name="prodweight" id="prodweight" onchange="weight()">
                        ...
                        <?php foreach ($weight as $w) { ?>
                            <option value="<?php echo $w->Weight_Id; ?>"<?php if($ed->Prod_Weight == $w->Weight_Id){
                                echo "selected";
                            } ?>>
            ...
            <div class="row justify-content-center">
                <div class="col-3">
                    ...
                    <input class="form-control" type=text name="prodgram" id="prodgram" value="<?php echo $ed->Prod_Gram; ?>" readonly>
                </div>
                <div class="col-2">
                    <label>ค่ากำเหน็จ :</label>
                    <input class="form-control" type=text name="fee" id="fee" value="<?php echo $ed->Fee; ?>" required onkeypress="return numberonly(event)" oninvalid="this.setCustomValidity('กรุณาใส่กำเหน็จ')" oninput="setCustomValidity('')">
                </div>
            </div>
            <br>
            <div class="row justify-content-center">
                <div class="col-5" style="margin-bottom: 15px;">
                    ...
                    <button type="submit"  class="btn btn-warning" name="updatePro" id="updatePro" value="<?php echo $ed->Prod_Id; ?>">แก้ไขข้อมูลสินค้า</button>
                    <a class="btn btn-danger"  href="<?php echo site_url('Welcome/product') ?>">ยกเลิก</a>
